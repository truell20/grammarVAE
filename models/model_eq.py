...
class MoleculeVAE():
    ...
    def _towers(self, x, f, max_length, max_length_func):
        ...
        # Tower 2
        hf = Flatten( name='tower_2_flatten')(f)
        hf = Dense(256, activation = 'relu', name='tower_2_dense_1')(hf)
#         hf = Flatten(name='tower_2_flatten_1')(hf)

        # Merge
        h = Concatenate()([h, hf])
        return Dense(self.hypers['dense'], activation = 'relu', name='dense_1')(h)
    ...
    def _buildDecoder(self, z, latent_rep_size, max_length, charset_length):
        l = BatchNormalization(name='batch_4')(z)
        l = Dense(latent_rep_size, name='latent_input', activation = 'relu')(l)
